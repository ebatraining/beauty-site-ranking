	...
	<div id="wrapper">
		...
		<main>
			<div class="flexslider">
				...
				<li><img src="images/top2.png"  alt="画像2"></li>
				<li><img src="images/top3.png"  alt="画像3"></li>
				<li><img src="images/top.png"  alt="画像1"></li>
				</ul>
			</div>
      ...
      <h1 class="midashi2">美しさを求める理由と欲求</h1>
          ...
          <section>
              <h3 class="baby1">&#9312;赤ちゃんが可愛い理由</h3>
                ...
                <div>
                  <img class="icon1" src="images/icon.png">
                </div>
            ...
            <section>
                  ...
                  <h3 class="balance">&#9313;「美しい」と感じるバランス</h3>
            ...
            <section>
                <h3 class="taisyou">&#9314;左右対称を求める本能</h3>
